...
import spark.domain.RandomExtractCar;
import spark.domain.RandomExtractMonitorDetail;
...
public class RandomExtractCars {
    ...
    public static void main(String[] args) {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("RandomExtractCars");
        ...
        //从配置文件中查询出来指定的任务ID
        Long taskIdFromArgs = ParamUtils.getTaskIdFromArgs(args, Constants.SPARK_LOCAL_TASKID_EXTRACT_CAR);
        ...
        Task task = taskDAO.findTaskById(taskIdFromArgs);
...
/**------------------------------------------------------------------------------------*/
         ...
         * 返回了(car,Row)
         */
        JavaPairRDD<String, Row> randomExtractCar2DetailRDD = randomExtractCarInfo(sparkContext,taskIdFromArgs,jsonObject,cameraRDD);
...
/**------------------------------------------------------------------------------------*/
            ...
            JavaRDD<Row> cameraRDD)
    {
        ...
        JavaPairRDD<String, String> dateHourCar2DetailRDD = cameraRDD.mapToPair(new PairFunction<Row, String, String>() {
            private static final long serialVersionUID = -4839404449220923503L;

            @Override
            public Tuple2<String, String> call(Row row) throws Exception {
                String actionTime = row.getString(4);
                String dateHour = DateUtils.getDateHour(actionTime);
                String car = row.getString(3);//车牌号
                /**
                 * 为什么要使用组合Key？
        ...
        JavaPairRDD<String, Row> car2DetailRDD = cameraRDD.mapToPair(
                new PairFunction<Row, String , Row>() {
                    private static final long serialVersionUID = 7324655158445577081L;
        ...
        for ( Map.Entry<String, Object> entry  : countByKey.entrySet())
        {
        ...
        //dateHourCountMap<String,Map<String,Long>> <==> dateHourCountMap<date,Map<hour,car>>
...
/**------------------------------------------------------------------------------------*/
        ...
        JavaPairRDD<String, String> extractCarRDD = dateHour2DetailRDD.groupByKey().flatMapToPair(new PairFlatMapFunction<Tuple2<String, Iterable<String>>, String, String>() {
            private static final long serialVersionUID = -498578740338450681L;
